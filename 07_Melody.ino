/*
   ...
   at https://www.tinkercad.com/things/hIXe2UdaiW3
   *** IMPORTANT NOTE: Tinkercad DOESN'T allow external libraries.
   *** You must add the contents of pitches.h 
   *** in place of the #include "pitches.h"
   shared on create.arduino.cc
   at https://create.arduino.cc/editor/janzeteachesit_tvbc/14eaa9f4-a619-4c73-9626-1406ce488032/preview
